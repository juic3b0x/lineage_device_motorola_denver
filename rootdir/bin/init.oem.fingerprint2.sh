...
vendor_list=('chipone' 'fpc' 'goodix')
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpsensor_spi_tee.ko" "/vendor/lib/modules/$GKI_PATH/fpc1020_mmi.ko" "/vendor/lib/modules/$GKI_PATH/goodix_fod_mmi.ko")
kernel_so_name_list=("fpsensor_spi_tee.ko" "fpc1020_mmi.ko" "goodix_fod_mmi.ko")
hal_list=('chipone_fp_hal' 'fps_hal' 'goodix_hal')
